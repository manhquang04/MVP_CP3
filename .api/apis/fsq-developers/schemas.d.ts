        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                readonly "X-Places-Api-Version": {
                    readonly type: "string";
                    readonly enum: readonly ["1970-01-01"];
                    readonly default: "1970-01-01";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
        ...
        readonly allOf: readonly [{
            ...
            readonly properties: {
                ...
                readonly add_chains: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Add chain IDs to the venue.";
                };
                readonly remove_chains: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Remove chain IDs to the venue.";
                };
                readonly primary_chain: {
                    readonly type: "string";
                    readonly $schema: "http://json-schema.org/draft-04/schema#";
                    readonly description: "Change the primary chain ID for the venue.";
                };
            };
            readonly required: readonly [];
        }, {
...
export { AddressDetails, FeedbackStatus, PlaceFlag, PlaceMatch, PlaceProposeEdit, PlaceSearch, PlaceSelect, PlaceTips, PlacesNearby };
